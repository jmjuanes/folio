...
export const CornerHandlers = props => (
    <g fill="#fff" stroke={props.color} strokeWidth="1">
        <rect
            ...
            onPointerDown={e => props.onPointerDown(e, topLeftHandler)}
        />
        <rect
            x={props.points[1][0]}
            ...
            onPointerDown={e => props.onPointerDown(e, topRightHandler)}
        />
        <rect
            x={props.points[2][0]}
            y={props.points[2][1]}
            ...
            onPointerDown={e => props.onPointerDown(e, bottomRightHandler)}
        />
        <rect
            ...
            onPointerDown={e => props.onPointerDown(e, bottomLeftHandler)}
        />
    </g>
);
