...
export const Menu = props => (
    <div className="flex relative group" tabIndex="0">
        ...
        <Dropdown className="hidden group-focus-within:block top-full left-0 mt-2 w-56 z-5">
            ...
            {props.showExport && (
                <Dropdown.Item
                    disabled={props.scene.elements.length === 0}
                    className={classnames({
                        "pointer-events-none": props.scene.elements.length === 0,
                    })}
            ...
            {props.showSettings && (
                <React.Fragment>
                    <Dropdown.Separator />
                    <Dropdown.CheckItem
                        checked={!!props.editor.state.grid}
                    ...
                    <Dropdown.CheckItem
                        checked={!!props.editor.state.presentation}
