...
import {PencilEffectFilter, PencilEffectProvider} from "../contexts/PencilEffectContext.jsx";
        ...
        >
            <div style={{position:"absolute", transform:transform.join(" ")}}>
                ...
                <AssetsProvider value={props.assets || {}}>
                    <PencilEffectProvider active={props.pencilEffect}>
