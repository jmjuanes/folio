...
export const BOOKMARK_OFFSET = 20;
export const BOOKMARK_BACKGROUND = WHITE;
export const BOOKMARK_IMAGE_WIDTH = BOOKMARK_WIDTH;
export const BOOKMARK_IMAGE_HEIGHT = 200;
export const BOOKMARK_TITLE_FONT_SIZE = 20;
export const BOOKMARK_DESCRIPTION_FONT_SIZE = 16;
export const BOOKMARK_LINK_FONT_SIZE = 16;
