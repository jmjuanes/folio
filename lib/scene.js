...
export const sceneActions = {
    ...
    pasteElements: (scene, elements, dx = 0, dy = 0) => {
    ...
    sendSelectionBackward(scene) {
        return sceneActions.sendElementsBackward(scene, sceneActions.getSelection(scene));
    },
    bringSelectionForward: (scene) => {
        return sceneActions.bringElementsForward(scene, sceneActions.getSelection(scene));
    },
    bringSelectionToFront: (scene) => {
        return sceneActions.bringElementsToFront(scene, sceneActions.getSelection(scene));
    },
    sendSelectionToBack: (scene) => {
        return sceneActions.sendElementsToBack(scene, sceneActions.getSelection(scene));
    },
