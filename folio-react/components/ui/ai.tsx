...
export type AiQuotasProps = {
    requestsLimit: number;
    requestsUsed: number;
};

export type AiComponents = {
    Prompt: (props: AiPromptProps) => JSX.Element;
    PromptInput: (props: AiPromptInputProps) => JSX.Element;
    PromptSubmit: (props: AiPromptSubmitProps) => JSX.Element;
    PromptButton: (props: AiPromptButtonProps) => JSX.Element;
    Conversation: (props: AiConversationProps) => JSX.Element;
    Message: (props: AiMessageProps) => JSX.Element;
    MessageContent: (props: AiMessageContentProps) => JSX.Element;
    MessageActions: (props: AiMessageActionsProps) => JSX.Element;
    MessageAction: (props: AiMessageActionProps) => JSX.Element;
    Artifact: (props: AiArtifactProps) => JSX.Element;
    ArtifactHeader: (props: AiArtifactHeaderProps) => JSX.Element;
    ArtifactTitle: (props: AiArtifactTitleProps) => JSX.Element;
    ArtifactActions: (props: AiArtifactActionsProps) => JSX.Element;
    ArtifactAction: (props: AiArtifactActionProps) => JSX.Element;
    Context: (props: AiContextProps) => JSX.Element;
    Quotas: (props: AiQuotasProps) => JSX.Element | null;
};
